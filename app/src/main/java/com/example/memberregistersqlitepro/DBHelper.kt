...
class DBHelper(val context: Context?, val name: String?, val version: Int) :
    ...
    fun selectCheckID(id: String): Boolean {
        ...
        try {
            ...
            Log.d("DBHelper", "selectCheckID 예외발생 ${e.printStackTrace()}")
        }
        return flag
    }
    ...
    fun selectLogin(id: String, password: String): Boolean {
        ...
        try {
            ...
            if (cursor.count >= 1) {
                ...
                Log.d("DBHelper", "selectLogin 로그인 실패")
            }
        } catch (e: SQLException) {
            Log.d("DBHelper", "selectLogin 예외 발생 ${e.printStackTrace()}")
        }
        return flag
    }
    ...
    fun selectID(id: String): Member? {
        ...
        try {
            ...
            Log.d("DBHelper", "selectID 예외 발생 ${e.printStackTrace()}")
        }
        return member
    }
    ...
    fun deleteTBL(id: String): Boolean {
        ...
        try {
            if(selectCheckID(id)){
                ...
                Log.d("DBHelper", "delete ${id}  실패")
            }

        } catch (e: SQLException) {
            Log.d("DBHelper", "delete 예외 발생 ${e.printStackTrace()}")
        }
        return flag
    }
    ...
    fun updateTBL(member: Member?): Boolean {
        ...
        try {
            ...
            Log.d("DBHelper", "update  예외 발생 ${e.printStackTrace()}")
        }
        return flag
    }
}
